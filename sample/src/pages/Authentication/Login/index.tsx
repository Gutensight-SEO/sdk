...
import { clearMessage, resetAuth } from '@/redux/features/auth/slice.auth.ts';
import { AppDispatch } from '@/redux/app/store.ts';

export const Login = () => {
  const dispatch = useDispatch<AppDispatch>();
  const navigate = useNavigate();
  const { status, error, message, isAuthenticated } = useSelector((state: any) => state.auth); // , success
